...
export default function CommentItem({
  ...
  return (
    <div className={classes.root}>
      ...
      <div>
        <b className={classes.growItem}>{comment.fullNameOfCreator}</b>
        <div className={classes.growItem}>{comment.commentMessage}</div>
        <div>
          <Button
            onClick={() => refToInPutComment()}
              ...
              listReplyComments.map((cmt) => (
                <div className={classes.root}>
                  ...
                  <div>
                    ...
                    <div className={classes.growItem}>{cmt.commentMessage}</div>
                  </div>
                </div>
              ))}
          </div>
