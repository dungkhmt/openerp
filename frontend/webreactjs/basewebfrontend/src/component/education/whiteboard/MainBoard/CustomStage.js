...
import {
  ...
  SOCKET_IO_EVENTS,
  TOOL,
} from "../../../../utils/whiteboard/constants";
...
export const CustomStage = React.memo(
  ({ page, totalPage, strokeDraw, tool, roleStatus, setTool }) => {
    ...
    const handleWheel = (e) => {
      ...
      const newScale =
        direction > 0 ? Number(oldScale) * scaleBy : Number(oldScale) / scaleBy;
