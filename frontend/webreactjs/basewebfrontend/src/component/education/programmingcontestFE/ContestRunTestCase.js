...
//       return (
//         <div>
//           <Typography variant={"h4"}>Submit Result</Typography>
...
//                         `${
//                           submitResult != undefined ? submitResult.status : ""
//                         }`
//                       ),
//                     }}
//                   >{`${
...
//                   <b>
//                     {submitResult != undefined ? submitResult.testCasePass : ""}
//                   </b>{" "}
//                   test cases passed.
//                 </Typography>
//               </Grid>
...
//                   Run Time:{" "}
//                   <i>
//                     {submitResult != undefined ? submitResult.runtime : ""} ms
//                   </i>
//                   <br />
//                   Memory Usage:{" "}
//                   <i>
//                     {submitResult != undefined ? submitResult.memoryUsage : ""}{" "}
//                     kb
//                   </i>
//                 </Typography>
//               </Grid>
...
//                 <Typography variant="h6" align="right">
//                   point:{" "}
//                   <b>{submitResult != undefined ? submitResult.score : ""}</b>
//                 </Typography>
//               </Grid>
//             </Grid>
//           </Box>
