...
export function ConsoleContest(props){
  ...
  const runTestCaseLoad = props.runTestCaseLoad;
  const runTestCaseShow = props.runTestCaseShow;
        ...
        <Box sx={{ width: '100%' }}>
          <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
            <Tabs value={consoleTabIndex} onChange={handleChange} aria-label="basic tabs example" indicatorColor={"primary"} style={{marginLeft:"20px", marginTop:"-10px"}}>
              ...
              <Tab label="Submit Result" {...a11yProps(2)} />
            </Tabs>
          </Box>
          ...
          <TabPanel value={consoleTabIndex} index={2}>
              <ContestRunTestCase
