    ...
    <>
        ...
        <Box sx={{ display: "flex" }}>
          ...
          <Box px={3} sx={{ width: "100%" }}>
            <Box sx={{ display: "flex", justifyContent: "space-between" }}>
              <Link
                to={`/taskmanagement/project/${id}/tasks`}
            ...
            <Box>
              <Link
                to={`/taskmanagement/project/tasks/create/${id}`}
                style={{ textDecoration: "none", marginRight: "15px" }}
              >
                Thêm n.vụ
              </Link>
              <Link
                to={`/taskmanagement/project/${id}/tasks#list-task`}
                style={{ textDecoration: "none", marginRight: "15px" }}
              >
                Danh sách n.vụ
              </Link>
              <Link
                to={`/taskmanagement/project/${id}/board`}
                style={{ textDecoration: "none", marginRight: "15px" }}
              >
                Board
              </Link>
      ...
      >
        <MenuItem onClick={handleClose}>
          <Link
            to={`/taskmanagement/project/type/update/${id}`}
            style={{ textDecoration: "none", color: "#000" }}
          >
            Chỉnh sửa dự án
          </Link>
