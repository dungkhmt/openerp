...
const SOCKET_URL = API_URL + "/handlerMeet";
...
const Room = () => {
  ...
  useEffect(() => {
    ...
    request(
      "get",
      "/roomParticipant/getParticipants?roomId=" + roomId,
      (res) => {
        setListPartcipant(
  ...
  const connect = () => {
    stompClient.connect(
      ...
      () => {
        stompClient.subscribe("/topic/meet/" + roomId, (message) =>
      ...
      new Peer({
        config: {
          iceServers: [
            ...
            {
              username:
                "ClmL5p96khHczNgr_ywdWfq_VlIuyMIqleZCjYznVGg0EXUj16fcSXf1Ek9hoM_0AAAAAGGjGJxob2FuZzMxMDU=",
