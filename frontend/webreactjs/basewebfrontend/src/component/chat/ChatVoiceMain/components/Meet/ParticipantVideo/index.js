...
export default function ParticipantVideo({ data, displayType, setDisplayType, setMediaHighlight }) {
  ...
  return (
    <div className={classNames('other-video', { active: displayExtend })} onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}>
