...
const ChatLiveParticipantListScreen = ({route}) => {
  console.log('ChatLiveParticipantListScreen: enter');

  // Observer results
  const participantList = route.params.participantList;

  useEffect(() => {
    console.log('ChatLiveParticipantListScreen.useEffect: enter');
  }, []);
...
export default ChatLiveParticipantListScreen;
