...
const getStudentClassQuizzesReducer = (state = initialState, action) => {
  // console.log('getStudentClassQuizzesReducer: enter, action=' + JSON.stringify(action));
  switch (action.type) {
    case types.GET_STUDENT_CLASS_QUIZZES:
      return {
        ...state,
        isFetching: true,
      };
    case types.GET_STUDENT_CLASS_QUIZZES_SUCCESS:
      return {
        ...state,
        quizList: action.quizList,
        isFetching: false,
      };
    case types.GET_STUDENT_CLASS_QUIZZES_FAILURE:
      return {
        ...state,
        isFetching: false,
...
export default getStudentClassQuizzesReducer;
