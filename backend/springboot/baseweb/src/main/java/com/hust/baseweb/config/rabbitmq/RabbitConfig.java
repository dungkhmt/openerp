...
public class RabbitConfig {
    ...
    @Value("${spring.rabbitmq.programming_contest.RABBIT_PC_CONCURRENT_CONSUMERS:4}")
    private int concurrentConsumer;

    @Value("${spring.rabbitmq.programming_contest.RABBIT_PC_MAX_CONCURRENT_CONSUMERS:8}")
    private int maxConcurrentConsumer;

    @Value("${spring.rabbitmq.programming_contest.RABBIT_PC_PREFETCH_COUNT:1}")
    private int prefetchCount;

    @Value("${spring.rabbitmq.programming_contest.RABBIT_PC_DEAD_MESSAGE_TTL:120000}")
