...
//				
//				avg_cost_A = Math.round(avg_cost_A/1000);
//				avg_cost_H = Math.round(avg_cost_H/1000);
//				nuy1 = Math.round((avg_cost_H - avg_cost_A)*10000/avg_cost_H); 
//				try{
//					FileOutputStream write = new FileOutputStream(summariseFile, true);
//					PrintWriter fo = new PrintWriter(write);
//					fo.println("\\textit{N}-" + nbReq[j] + "-" + i 
//						+ " & " + Math.round(avg_cost_H) + " & " + Math.round(std_H/1000) 
//						+ " & " + avg_time_H + " & " + avg_reject_H + " & " + avg_truck_H 
//						+ " & " + Math.round(avg_cost_A) + " & " + Math.round(std_A/1000) 
...
//	}
//	
//	public void readHeuristicCostandRejectForSummarise_LS_HASBPIUS(){
//		int[] nbReq = new int[]{20, 70, 100, 150, 200};
//		String dir = "data/truck-container/";
//		String summariseFile = dir + "output/LocalSearch/summarise-LS-HASBPIUS-reject-truck-cost.txt";
//		
//		try{
//			FileOutputStream write = new FileOutputStream(summariseFile);
//			PrintWriter fo = new PrintWriter(write);
//			fo.println("Ins & avg_reject_HAS & avg_truck_HAS & avg_cost_HAS & std_HAS & avg_time_HAS & avg_reject_LS & avg_truck_LS & avg_cost_LS & std_LS & avg_time_LS & nuy1 \\\\");
//			
//			fo.close();
//		}catch(Exception e){
//			System.out.println(e);
...
//					String fileName = "random-" + nbReq[j] + "reqs-RealLoc-" + i;
//					
//					String outputLSfileTxt = dir + "output/LocalSearch/result-" + fileName + ".txt-LCS-" + k + ".txt";
//					String outputHASfileTxt = dir + "output/newOutput/It-" + k +"-HASBPIUS-" + fileName + ".txt";
//					
//					ScannerInput sc = new ScannerInput(outputLSfileTxt);
//					
//					String str = "";
//					boolean is = false;
//					ArrayList<Integer> iterList = new ArrayList<Integer>();
...
//			PrintWriter fo = new PrintWriter(write);
//			fo.println("Ins & avr_nbR & avr_nbTruck & avg_cost_BPI & stv_BPI & avg_time_BPI & avg_nbR_BPIUS & avg_nbTruck_BPIUS & avg_cost_BPIUS & stv_BPIUS & avg_time_BPIUS & nuy1 \\\\");
//			
//			fo.close();
//		}catch(Exception e){
//			System.out.println(e);
...
//							avg_time_BPI += Double.parseDouble(time[1]);							String[] abc = brLine[1].split("=");
//							avgnbR_BPI += Integer.parseInt(brLine[1].split("=")[1].trim());
//							avgnbT_BPI += Integer.parseInt(brLine[2].split("=")[1].trim());
...
//							
//							avgnbR_BPIUS += Integer.parseInt(brLine[1].split("=")[1].trim());
//							avgnbT_BPIUS += Integer.parseInt(brLine[2].split("=")[1].trim());
...
//				avgnbR_BPI = avgnbR_BPI/nbIters;
//				avgnbT_BPI = avgnbT_BPI/nbIters;
//				
...
//				avgnbR_BPIUS = avgnbR_BPIUS/nbIters;
//				avgnbT_BPIUS = avgnbT_BPIUS/nbIters;
//				
...
//				
//				avg_cost_BPI = Math.round(avg_cost_BPI/1000);
//				avg_cost_BPIUS = Math.round(avg_cost_BPIUS/1000);
//				String avgcostBPIstr = Math.round(avg_cost_BPI) + "";
//				String avgcostBPIUSstr = Math.round(avg_cost_BPIUS) + "";
//				if(avg_cost_BPIUS < avg_cost_BPI)
//					avgcostBPIUSstr = "\\textbf{" + Math.round(avg_cost_BPIUS) + "}";
//				else if(avg_cost_BPI < avg_cost_BPIUS)
//					avgcostBPIstr = "\\textbf{" + Math.round(avg_cost_BPI) + "}";
//				
//				String avgnbR_BPIstr = avgnbR_BPI + "";
//				String avgnbR_BPIUSstr = avgnbR_BPIUS + "";
//				if(avgnbR_BPIUS < avgnbR_BPI)
//					avgnbR_BPIUSstr = "\\textbf{" + avgnbR_BPIUS + "}";
//				else if(avgnbR_BPI < avgnbR_BPIUS)
//					avgnbR_BPIstr = "\\textbf{" + avgnbR_BPI + "}";
//				
//				String avgnbT_BPIstr = avgnbT_BPI + "";
//				String avgnbT_BPIUSstr = avgnbT_BPIUS + "";
//				if(avgnbT_BPIUS < avgnbT_BPI)
//					avgnbT_BPIUSstr = "\\textbf{" + avgnbT_BPIUS + "}";
//				else if(avgnbT_BPI < avgnbT_BPIUS)
//					avgnbT_BPIstr = "\\textbf{" + avgnbT_BPI + "}";
//				
//				String avgTime_BPIstr = avg_time_BPI + "";
//				String avgTime_BPIUSstr = avg_time_BPIUS + "";
//				if(avg_time_BPIUS < avg_time_BPI)
//					avgTime_BPIUSstr = "\\textbf{" + avg_time_BPIUS + "}";
//				else if(avg_time_BPI < avg_time_BPIUS)
//					avgTime_BPIstr = "\\textbf{" + avg_time_BPI + "}";
//				
//				nuy2 = nuy2/100;
//				String nuy2str = nuy2 + "";
//				if(nuy2 < 0)
...
//					PrintWriter fo = new PrintWriter(write);
//					fo.println("\\textit{N}-" + nbReq[j] + "-" + i + " & " + avgnbR_BPIUSstr + " & "
//						+ avgnbT_BPIUSstr + " & " + avgcostBPIstr + " & " + Math.round(stdev_BPI/1000) + " & "
//						+ avgTime_BPIstr + " & " + avgnbR_BPIstr + " & " + avgnbT_BPIUSstr + " & "
//						+ avgcostBPIUSstr + " & " + Math.round(stdev_BPIUS/1000) + " & " + avgTime_BPIUSstr + " & "
//						+ nuy2str + " \\\\");
//					fo.println("\\hline");
//					fo.close();
//				}catch(Exception e){
