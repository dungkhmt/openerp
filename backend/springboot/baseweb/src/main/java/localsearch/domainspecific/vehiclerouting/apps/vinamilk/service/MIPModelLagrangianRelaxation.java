...
//
//
//public class MIPModelLagrangianRelaxation {
...
//	int M = 65000;
//	
//	public MIPModelLagrangianRelaxation(){
//	}
//	
...
//					try {
//						GRBVar var = model.addVar(0.0, maxItem, 0.0, GRB.CONTINUOUS, "L(" + k + "," + p + "," + q + ")");
//						L.add(var);
//						String s = k + "-" + p + "-" + q;
//						arc2L.put(s, var);
//					} catch (GRBException e) {
...
//					try {
//						GRBVar var = model.addVar(0.0, 1.0, 0.0, GRB.CONTINUOUS, "W(" + k + "," + i + "," + q + ")");
//						W.add(var);
//						String s = k + "-" + i + "-" + q;
//						point2W.put(s, var);
//					} catch (GRBException e) {
...
//						for(int v : inArcVehicles.get(dp)){
//							if(!parkings.contains(v)){
//								String s = k + "-" + v + "-" + dp + "-" + q;
//								GRBVar x1 = arc2X.get(s);
//								expr.addTerm(1, x1);
//							}
//						}
//						for(int v : outArcVehicles.get(dp)){
//							if(!parkings.contains(v)){
//								String s = k + "-" + dp + "-" + v + "-" + (q+1);
//								GRBVar x2 = arc2X.get(s);
//								expr.addTerm(-1, x2);
//							}
//						}
//						model.addConstr(expr, GRB.EQUAL, 0.0, "BalanceFlowOnEachTrip(" + k + "," + dp + "," + q + ")");
//					}
//				}
//			}
//		} catch (GRBException e) {
...
//		SubSetGenerator ssgen = new SubSetGenerator(truckPoints);
//		ssgen.generate();
//		int t = 0;
//		try{
//			for(HashSet<Integer> s : ssgen.subSet){
...
//				int pk = vh2parking.get(k);
//				for(int j : centralDepots){
//					String kjpkq = k + "-" + pk + "-" + j + "-0";
//					GRBVar x1 = arc2X.get(kjpkq);
//					expr1.addTerm(1, x1);
//				}
//				String k0 = k + "-0";
//				GRBVar z = arc2Z.get(k0);
//				model.addConstr(expr1, GRB.EQUAL, z, "vhStartParkingAtMostone(" + k + "," + pk + ")");
...
//								model.addConstr(expr1, GRB.LESS_EQUAL, M - tij - serviceDuration[u], "stTimeAtDepotConstr1(" + k + "," + u + "," + dp + "," + q + ")");
//								
////								GRBLinExpr expr2 = new GRBLinExpr();
...
////								expr2.addTerm(-1, stkdpq);
////		
////								model.addConstr(expr2, GRB.GREATER_EQUAL, -M - tij - serviceDuration[u], "stTimeAtDepotConstr2(" + k + "," + u + "," + dp + "," + q + ")");	
//							}
//						}
//					}
//				}
...
//		flowBalanceConstraintMiller(model);
...
//	}
//	
//	public void defineProblem(GRBModel model){
//		defineVariables(model);
//		flowBalanceConstraint(model);
//		flowBalanceConstraintMiller(model);
//		defineServingTimeConstraint(model);
//		defineServingTimeAtPointsWithTimeWindow(model);
...
//					fw.println(X.get(i).get(GRB.StringAttr.VarName) + " "
//							+ X.get(i).get(GRB.DoubleAttr.X));
//				}
//			}
//			
...
//					fw.println(L.get(i).get(GRB.StringAttr.VarName) + " "
//							+ L.get(i).get(GRB.DoubleAttr.X));
//			}
//			
...
//				fw.println(servingTimeAtPoint.get(i).get(GRB.StringAttr.VarName) + " "
//						+ servingTimeAtPoint.get(i).get(GRB.DoubleAttr.X));
//			}
//			
//			String d = "";
...
//		MIPModelLagrangianRelaxation m = new MIPModelLagrangianRelaxation();
//
//		
//		try{
